    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;" autocomplete="off">
        <div style="width:100%;height: 90%;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rDate" name="rDate" value="${equDetail.RDate?string("yyyy-MM-dd")}" readonly class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rState" name="rState" value="${equDetail.RState}" readonly class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rentState" name="rentState" value="${equDetail.rentState}" readonly class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rFinish" name="rFinish" value="${(equDetail.RFinish?string("yyyy-MM-dd"))!}" readonly class="layui-input">
                </div>
            </div>
