    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'rDate', title: '使用期限', width: '15%',templet: '<div>{{ d.rDate ? layui.laytpl.toDateString(d.rDate,"yyyy-MM-dd"): "" }}</div>'}
                , {field: 'rState', title: '设备状态', width: '10%'}
                , {field: 'rentState', title: '租借状态', width: '10%'}
                , {field: 'rFinish', title: '归还时间', width: '15%',templet: '<div>{{ d.rFinish ? layui.laytpl.toDateString(d.rFinish,"yyyy-MM-dd"): "" }}</div>'}
