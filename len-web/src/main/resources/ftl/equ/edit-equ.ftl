        ...
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="rDate" readonly name="rDate" value="${equDetail.RDate?string("yyyy-MM-dd")}"
                               class="layui-input">
                    </div>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select id="selectRState" name="rState" lay-verify="nnull" lay-search>
                            <option value="well">完好</option>
                            <option value="bad">损坏</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select disabled id="selectRentState"  name="rentState" lay-verify="nnull" lay-search>
                            <option value="done">已归还</option>
                            <option value="doing">未归还</option>
                        </select>
                    </div>
                </div>
            </div>
