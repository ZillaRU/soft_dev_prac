        ...
        <div style="width:100%;height: 100%;">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select id="proRoleId" name="proRoleId">
                            <option value=0>开发负责人</option>
                            <option value=1>开发人员</option>
                            <option value=2>测试负责人</option>
                            <option value=3>测试人员</option>
                            <option value=4>配置管理人员</option>
                            <option value=5>QA</option>
                            <option value=6>EPG</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            var role = $("#proRoleId option:selected").val();
            data.field.proRoleId = parseInt(role, 10);
