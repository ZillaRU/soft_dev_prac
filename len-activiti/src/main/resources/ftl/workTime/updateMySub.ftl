    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px; margin-top:20px " autocomplete="off">
        <div style="width:100%;height: 90%;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="chooseFunc" name="chooseFunc" value="${baseInfo.funcName}" lay-search
                            lay-filter="chooseFunc">
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="endTime" name="endTime" value="${baseInfo.endTime}" autocomplete="off"
                           placeholder="HH:mm:ss" class="layui-input" lay-verify="subEndTime">
                </div>
            </div>
            <div class="layui-form-item">
