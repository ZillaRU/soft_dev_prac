    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px; margin-top:20px " autocomplete="off">
        <div style="width:100%;height: 90%;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="subDate" name="subDate" placeholder="YYYY-MM-dd" value="${baseInfo.submitDate}"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="chooseFunc" name="chooseFunc" value="${baseInfo.funcName}" lay-search lay-filter="chooseFunc">
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="chooseActiv" name="chooseActiv" lay-search lay-verify="nnull" value="${baseInfo.activId}">
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="startTime" name="startTime" autocomplete="off" class="layui-input"
                           value="${baseInfo.startTime}" placeholder="HH:mm:ss" lay-verify="substartTime">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="endTime" name="endTime" value="${baseInfo.endTime}" autocomplete="off" placeholder="HH:mm:ss" class="layui-input" lay-verify="subEndTime">
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <script>
        layui.use(['form', 'laydate', 'layer'], function () {
            ...
            form.on('submit(submit)', function (data) {
                ...
                layerAjax('updateMySubmWorInfo', data.field, 'mySubWorkTimeList');
                return false;
            });
